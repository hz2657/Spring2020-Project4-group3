...
Given data sets including 610 users and 9725 movies, we implemented ALS withour regularions and ALS with regulations(R1 and R2).After fitting the model, we used Kernel Ridge Regreesion for postprocessing. Our result shows that the more latent factors we use, the lower the final RMSE is. 
